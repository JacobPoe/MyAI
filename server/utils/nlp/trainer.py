...
class Trainer:
    ...
    @staticmethod
    def tokenize_dataset(dataset, t):
        """
        (param dataset): The corpus of data to be tokenized returned from combine_datasets().
        (param t): The tokenizer generated by AutoTokenizer.from_pretrained().
        """
